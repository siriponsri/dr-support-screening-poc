...
![Worklist with synthetic cases. Confirmed rows show the patient key and eye; unconfirmed rows offer **Link patient and confirm eye**.](screenshots/01-worklist.png){#fig-worklist width=100%}
...
1. In the case row, open the menu (**...**) and choose **Confirm Image**.
...
5. Enter your **Reviewer name**. Select **Use as default reviewer on this workstation** to prefill it next time.
6. Choose **Confirm Image**.

**Expected result.** The patient and eye context, reviewer, and timestamp are saved, and the row shows **Confirmed**. The case can proceed to **Review**.
::::
:::: {}
