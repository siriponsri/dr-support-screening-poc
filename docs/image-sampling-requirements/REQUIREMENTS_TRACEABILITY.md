...
| IMG-SAMP-005 | `docs/DATASET_MANIFEST.md` (`filename` column); `docs/SECURITY_PRIVACY.md` | None |
| IMG-SAMP-010 | No `Refer`/`Not-refer` field in `dr_support/**` or `frontend/src/**` | Owner decision (V4) |
| IMG-SAMP-011 | `dr_support/workflow.py` `Review` (grade 0–4), `grade_review_source`; `docs/DATASET_MANIFEST.md` | NHS DESP grading definitions [E2] (grading and referral are separate schemes) |
...
| IMG-SAMP-091 | `docs/DATASET_MANIFEST.md` (`image_id`, `image_sha256`) | [E10] |
| IMG-SAMP-092 | None | Owner decision (V4) |
| IMG-SAMP-100 | None | Owner decision (V4 acceptance) |
| IMG-SAMP-101 | `docs/image-selection/IMAGE_SELECTION_GUIDE.html` | Nielsen Norman Group, *Progressive Disclosure* |
| IMG-SAMP-110 | `docs/SECURITY_PRIVACY.md`; `normalize_patient_key` in `dr_support/services/resolver.py` | None |
