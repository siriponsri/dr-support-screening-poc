...
**Previous** and **Next** move through the case order shown in the middle (for example `1 of 7`). Moving does not save or confirm anything. **Confirm DR Grade** continues to the Annotation Editor; **Confirm Annotation** completes the annotation milestone and opens the next case when one exists.
